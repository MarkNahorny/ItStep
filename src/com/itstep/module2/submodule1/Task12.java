    ...
    public static void main(String[] args) {
        ...
        if (task == 1) {
            ...
            if (Math.ceil(0.6 * students) == (0.6 * students)) {
                ...
                System.out.print("Недостаточное количество учеников для 60 процентов");
                return;
            }
        } else if (task == 3) {
            if (Math.ceil(0.01 * students) == (0.01 * students)) {
                ...
                System.out.print("Недостаточное количество учеников для 1 процента");
                return;
            }
        } else {
            System.out.print("Введите правильное условие (1, 2, 3)");
            return;
        }
